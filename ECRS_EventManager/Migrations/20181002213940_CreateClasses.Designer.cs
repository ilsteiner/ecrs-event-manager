...
namespace ECRS_EventManager.Migrations
{
    ...
    [Migration("20181002213940_CreateClasses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManager.Models.ClassPriority", b =>
                {
                    b.Property<int>("Priority")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("EventClassID");

                    b.Property<Guid?>("RegistrationEntryID");

                    b.HasKey("Priority");

                    b.HasIndex("EventClassID");

                    b.HasIndex("RegistrationEntryID");

                    b.ToTable("ClassPriority");
                });
            ...
            modelBuilder.Entity("EventManager.Models.EventClass", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("EventManager.Models.ClassPriority", b =>
                {
                    b.HasOne("EventManager.Models.EventClass", "EventClass")
                        .WithMany()
                        .HasForeignKey("EventClassID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("EventManager.Models.RegistrationEntry")
                        .WithMany("ClassPriorities")
                        .HasForeignKey("RegistrationEntryID");
                });
